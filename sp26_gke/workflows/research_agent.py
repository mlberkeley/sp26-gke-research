...
def _graph_checkpointer_context(persist: bool):
    ...
    if persist and _PostgresSaver is not None and os.getenv("DATABASE_URL"):
        return _PostgresSaver.from_conn_string(os.environ["DATABASE_URL"])
...
def run() -> int:
    ...
    if is_resume and not persist:
        ...
        return 1
    if is_resume and _PostgresSaver is None:
        print(
